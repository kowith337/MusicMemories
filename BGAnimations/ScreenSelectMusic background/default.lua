local t = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		Def.Sprite {
			...
			--ModifySongBackgroundCommand=cmd(LoadFromCurrentSongBackground);
			...
			-- 			self:visible(false);
			-- 		end;
			-- 		self:diffusealpha(scale(1,0,1,1,0.75))
			-- 		--Nighty() is just function that return how much *Nighty* at that local time.
			-- 	else
			-- 		self:visible(false);
			-- 		self:Load()
			-- 	end;
