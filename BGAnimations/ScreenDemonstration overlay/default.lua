local t = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		Def.ActorFrame{
			OnCommand=cmd(thump;effectclock,"beat");
		LoadFont("Common normal")..{
			Text="Demo";
			InitCommand=cmd(diffusealpha,0;strokecolor,color("0,0,0,0.5"));
			OnCommand=cmd(smooth,0.75;diffusealpha,1;diffuseshift;effectcolor1,HSV(38,0.45,0.95);effectclock,"beat");
		};
		};
		LoadFont("Common normal")..{
			Text="It's just demo";
			InitCommand=cmd(diffusealpha,0;strokecolor,color("0,0,0,0.5");zoom,0.5;y,15);
			OnCommand=cmd(smooth,0.75;diffusealpha,1);
		};
	};
