...
InitCommand=function(self)
			...
			function colourText(s,e,r,g,b,a)
				...
				for i=s,e do
					if r == 'ran' then
						n = (math.random(0,100))/100
					elseif r == 'ran/2' then
						n = ((math.random(0,100))/100)/2
					else
						n = r
					end
					if g == 'ran' then
						t = (math.random(0,100))/100
					elseif g == 'ran/2' then
						t = ((math.random(0,100))/100)/2
					else
						t = g
					end
					if b == 'ran' then
						p = (math.random(0,100))/100
					elseif b == 'ran/2' then
						p = ((math.random(0,100))/100)/2
					else
						p = b
					end
					_G['let'..i]:diffuse(n,t,p,a)
				end
