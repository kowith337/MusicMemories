...
local stepmania_credits= {
	...
	{
		name= "Theme's Credit",
		{type= "subsection", name= "Main Project"},
		"Nepumi",
		{type= "subsection", name= "Inspiration"},
		"Plastic Memories...",
		"Some MEME",
		{type= "subsection", name= "Music"},
		"Plastic Memories OST",
		"Bach , Air (from Orchestral Suite No. 3 in D)",
		"CupHead OST",
		{type= "subsection", name= "Player-Testor"},
		"Sushi_Roll",
		{type= "subsection", name= "Used Font"},
		"chakra petch",
		"And More!...",
	},
	{
		...
		"Simply-Love Theme(dbk2)",
		"Differential",
		"Every Friend that helped me...",
		"",
		"Isla...",
	},
	{
